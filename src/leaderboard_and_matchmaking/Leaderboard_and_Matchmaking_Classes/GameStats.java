...
public class GameStats {
    ...
    /**
     * This function updates the player ranking among other players. This can be changed later
     * to fit how Leaderboards update their ranks
     */
    public void setRank() {
        LeaderboardData.updateRank(ELO);
    }
