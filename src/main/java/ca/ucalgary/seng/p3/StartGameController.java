...
public class StartGameController {
    ...
    public void handleLeaderboardButton(ActionEvent actionEvent) {
    }

    public void handleFindAPlayerButton(ActionEvent actionEvent) {
    }

    public void handleSettingsButton(ActionEvent actionEvent) {
    }

    public void handleGameRulesButton(ActionEvent actionEvent) {
    }
